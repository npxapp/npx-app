  ...
  try {
    ...
    const session = {
      ...
      payment_method_details: {
        card: {
          last4: Math.floor(1000 + Math.random() * 9000).toString(),  // Random 4-digit number as last4
          brand: getRandomCardBrand()  // Randomly selected card type in lowercase
        }
      }
    };
    ...
    console.error('Error processing /test/success route:', error);
