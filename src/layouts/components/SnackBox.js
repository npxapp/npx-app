...
import { useScrolled } from '../../contexts/ScrolledContext'; // Import the ScrolledContext
...
const SnackBox = () => {
  ...
  const { scrolled } = useScrolled(); // Use the scrolled state from context
  ...
  return (
    <>
      ...
      <AppBar
        ...
        sx={{
          top: 'auto',
          bottom: scrolled ? 0 : '-100%', // Hide when not scrolled
