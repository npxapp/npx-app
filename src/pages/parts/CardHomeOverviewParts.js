...
import PersonPinIcon from '@mui/icons-material/PersonPin';import { useDarkMode } from '../../contexts/DarkMode';
...
import logo from '../../images/paths.svg';
      ...
      content={
        <>
          <List sx={CardListStyles(darkMode)}>
            <ListItem>
              <ListItemText primary="Deploy Your SPA Today" sx={CardListItemStyles(darkMode)} />
            </ListItem>
          </List>
        </>
      }
