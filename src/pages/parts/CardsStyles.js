...
export const CardHeaderStyles = (darkMode: boolean) => ({
  ...
  background: darkMode ? '#61dafb' : '#000',
  textAlign: 'center',
...
export const AvatarIconStyles = (darkMode: boolean) => ({
  ...
  height: '80px',
  borderRadius: '50%',
  background: darkMode ? 'rgba(97, 218, 251, 0.1)' : 'rgba(0, 0, 0, 0.05)',
...
export const CardPurchaseButtonStyles = (darkMode: boolean) => ({
  ...
  background: darkMode ? 'transparent' : '#000',
  ...
  width: 'fit-content',
  '&:hover': {
    background: darkMode ? '#61dafb' : 'rgba(97, 218, 251, 0.1)',
